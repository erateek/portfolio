export const PRICING_CONFIG = {
  services: [
    ...
    },
    {
      ...
      basePrice: 200, // Monthly
      icon: "Megaphone"
    }
  ],
  features: {
    website: [
      { id: "cms", label: { ar: "نظام إدارة محتوى", en: "CMS (Content Management)" }, price: 100 },
      { id: "seo", label: { ar: "تحسين محركات البحث", en: "SEO Optimization" }, price: 50 },
    ...
    ecommerce: [
      ...
      { id: "multi_vendor", label: { ar: "تعدد البائعين", en: "Multi-vendor Support" }, price: 400 }
    ],
    app: [
